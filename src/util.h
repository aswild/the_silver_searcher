...
STATIC_ALWAYS_INLINE int ag_pcre2_match(const pcre2_code *code, const char *subject,
...
void die(const char *fmt, ...) ATTR_FORMAT_PRINTF(1, 2) ATTR_NORETURN;

void ag_asprintf(char **ret, const char *fmt, ...) ATTR_FORMAT_PRINTF(2, 3);
int ag_dsprintf(char **buf, size_t *bufsize, size_t pos, const char *fmt, ...) ATTR_FORMAT_PRINTF(4, 5);
